...
export const BeakerIcon: React.FC<IconProps> = (props) => (
    <svg {...props} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 3.104v5.714a2.25 2.25 0 01-.659 1.591L5 14.5M9.75 3.104c.242.013.487.02.73.022h.022c.243-.002.487-.009.73-.022M9.75 3.104L11.25 2.25m-1.5.854L11.25 2.25m2.25 10.25l-1.519-.933a2.25 2.25 0 00-1.981 0l-1.519.933m2.25 1.5l1.519.933a2.25 2.25 0 001.981 0l1.519-.933M4.5 21V15m15-9v6m-6-6v6m0 6v-6m6 6v-6m0 6h-6m6 0h3" />
    </svg>
);
