...
const services = [
  ...
  { icon: <LifebuoyIcon />, title: "Soutien Numérique Seniors/Débutants", description: "Assistance informatique, antivirus et dépannage.", href: "/soutien-seniors" },
];
...
const ServiceCard: React.FC<{
  ...
  return (
    <Link
      href={href}
      className="group relative block p-8 bg-gray-900/50 border border-gray-800 rounded-xl transition-all duration-300 hover:border-[#6366F1] hover:-translate-y-1"
    >
      ...
      <div className="relative z-10">
        ...
        <span
          ...
          className="inline-flex items-center px-4 py-2 bg-[#6366F1] text-white font-medium rounded-lg transition-colors duration-300 group-hover:bg-[#00FFB3] group-hover:text-gray-900"
        >
          En savoir plus
        </span>
      </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="mt-4 text-lg text-gray-400 max-w-2xl mx-auto">
            Des solutions complètes pour intégrer l'intelligence artificielle au cœur de votre métier.
          </p>
        </div>
